...
namespace Penfolio2.Areas.Identity.Pages.Account.Manage
{
    public class EmailModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required]
            [CustomUsernameEmailPolicy.CustomEmailPolicyForUpdate]
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                foreach(string e in db.Users.Where(u => u.Id != userId).Select(u => u.NormalizedEmail))
                {
                    if(e == CustomUsernameEmailPolicy.NormalizeEmail(Input.NewEmail))
                    {
                        StatusMessage = "Could not change your email address because the email address is already in use by another account.";
                        return RedirectToPage();
                    }
                } //check for duplicate addresses before making a change
