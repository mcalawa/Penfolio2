...
namespace Penfolio2.Data.Migrations
{
    ...
    [Migration("20230517004738_added new column to keep track of other friendship Id")]
    partial class addednewcolumntokeeptrackofotherfriendshipId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Penfolio2.Models.Friendship", b =>
                {
                    ...
                    b.Property<int?>("OtherFriendshipId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Penfolio2.Models.PenUser", b =>
                {
                    ...
                    b.Property<DateTime>("LastNotificationViewDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Penfolio2.Models.PublisherWriter", b =>
                {
                    b.Property<int>("PublisherWriterId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PublisherWriterId"));
                    ...
                    b.HasKey("PublisherWriterId");

                    b.HasIndex("PublisherId");

                    b.HasIndex("WriterId");

                    b.ToTable("PublisherWriter", "dbo");
                });

            modelBuilder.Entity("Penfolio2.Models.RepresentationRequest", b =>
                {
                    b.Property<int>("RepresentationRequestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("RepresentationRequestId"));
                    ...
                    b.ToTable("RepresentationRequest", "dbo");
                });
            ...
            modelBuilder.Entity("Penfolio2.Models.PublisherWriter", b =>
                {
                    b.HasOne("Penfolio2.Models.PenProfile", "Publisher")
                        .WithMany("PublisherWriters")
                        .HasForeignKey("PublisherId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Penfolio2.Models.PenProfile", "Writer")
                        .WithMany("WriterPublishers")
            ...
            modelBuilder.Entity("Penfolio2.Models.RepresentationRequest", b =>
                {
                    b.HasOne("Penfolio2.Models.PenProfile", "Requestee")
                        .WithMany("RepresentationRequestsReceived")
                        .HasForeignKey("RequesteeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Penfolio2.Models.PenProfile", "Requester")
                        .WithMany("RepresentationRequestsSent")
                        .HasForeignKey("RequesterId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Penfolio2.Models.PenProfile", b =>
                {
                    ...
                    b.Navigation("PublisherWriters");

                    b.Navigation("RepresentationRequestsReceived");

                    b.Navigation("RepresentationRequestsSent");

                    b.Navigation("WriterPublishers");
                });
